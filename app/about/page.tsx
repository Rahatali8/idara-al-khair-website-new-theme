...
export default function AboutPage() {
  return (
    <main className="min-h-screen">
      {/* Hero Section */}
      <section className="relative min-h-[80vh] sm:min-h-[86vh] flex items-center justify-center overflow-hidden px-4 sm:px-9 lg:px-8  ">
  {/* Background Image */}
  <div className="absolute inset-0 z-0">
    <Image
      ...
      fill
      className="object-cover opacity-70 blur-[2px] px-2 "
      priority
    />
  </div>
  ...
  <div className="relative z-10 text-center max-w-4xl mx-auto">
    <motion.h1
      className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-6 flex flex-wrap justify-center leading-tight"
      initial="hidden"
      animate="visible"
      variants={{
    ...
    >
      {['About', 'Idara', 'Al-Khair'].map((word, i) => (
        <motion.span
          key={i}
          className={`mx-2 ${word === 'Al-Khair' ? 'text-lightblue' : 'text-darkblue'}`}
          variants={{
    ...
    <motion.p
      className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-700 leading-relaxed mb-8 px-2 sm:px-4"
      initial="hidden"
      animate="visible"
      variants={{
    ...
    <div className="flex flex-col sm:flex-row gap-4 justify-center">
      <Link href={"/donate"}>
        <button className="relative px-6 sm:px-8 py-2 sm:py-3 font-semibold rounded-full border-2 border-lightblue text-lightblue overflow-hidden group bg-white transition duration-300 hover:bg-lightblue hover:text-white">
...
<section id="president-message" className="py-16 sm:py-20 px-4 sm:px-6 lg:px-10">
  <div className="container mx-auto">
    ...
    <div className="mb-10">
      <div className="flex flex-col lg:flex-row items-center justify-center mb-4 text-center lg:text-left">
        ...
        <div className="px-4 sm:px-8">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-darkblue">
            Message from the <span className="text-lightblue">President</span>
          </h2>
          <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto mt-3">
            A note from our founder and president, sharing the vision and journey of Idara Al-Khair.
          </p>
        </div>
    ...
    {/* Content Grid */}
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center bg-white rounded-xl p-6 sm:p-8 shadow-md">
      {/* Image Side */}
      <div className="flex justify-center md:justify-center lg:justify-end order-1 lg:order-none">
  <Image
    src="/chairmain.jpg"
  ...
  />
      ...
      <div className="text-center lg:text-left ">
        <h3 className="text-2xl sm:text-3xl xl:text-5xl font-bold text-darkblue mb-3">
          Mohammad Mazahir
        </h3>
        <p className="text-base   xl: text-justify sm:text-lg text-gray-700 mb-4 leading-relaxed">
        ...
        <p className="text-base  text-justify sm:text-lg text-gray-700 leading-relaxed">
...
<section id="mission-vision" className="px-3 sm:px-6 md:px-10 lg:px-16 py-16 sm:py-20 bg-white">
  {/* Section Heading */}
  <div className="mb-12">
    <div className="flex flex-col lg:flex-row items-center justify-center text-center lg:text-left mb-4">
      ...
      {/* Heading */}
      <div className="px-4 sm:px-8">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-3 text-darkblue leading-snug">
          Our Mission <span className="text-lightblue">& Vision</span>
        </h2>
        <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto mt-2">
          Empowering communities through education, healthcare, and hope for a brighter future.
        </p>
      </div>
  ...
  <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
    {/* Mission Card */}
    <div className="relative rounded-2xl shadow-xl overflow-hidden min-h-[320px] sm:min-h-[380px] md:min-h-[420px] flex items-center justify-center">
      <img src="/vision-back.jpg" alt="Mission" className="absolute inset-0 w-full h-full object-cover z-0 blur-sm" />
      <div className="absolute inset-0 bg-black/50 z-10" />
      <div className="relative z-20 flex flex-col justify-center items-center p-6 sm:p-10 md:p-12 lg:p-16 w-full h-full text-center font-sans">
        <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-white tracking-wider mb-2 drop-shadow-xl uppercase">Mission</div>
        <div className="w-10 sm:w-12 h-1 bg-gradient-to-r from-teal-400 to-blue-400 rounded-full mb-4" />
        <div className="text-base sm:text-lg md:text-xl text-white/90 leading-relaxed font-light drop-shadow-lg max-w-xl mx-auto tracking-wide" style={{ letterSpacing: '0.01em' }}>
    ...
    <div className="relative rounded-2xl shadow-xl overflow-hidden min-h-[320px] sm:min-h-[380px] md:min-h-[420px] flex items-center justify-center">
      ...
      <div className="absolute inset-0 bg-black/50 z-10" />
      <div className="relative z-20 flex flex-col justify-center items-center p-6 sm:p-10 md:p-12 lg:p-16 w-full h-full text-center font-sans">
        <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-white tracking-wider mb-2 drop-shadow-xl uppercase">Vision</div>
        <div className="w-10 sm:w-12 h-1 bg-gradient-to-r from-blue-400 to-teal-400 rounded-full mb-4" />
        <div className="text-base sm:text-lg md:text-xl text-white/90 leading-relaxed font-light drop-shadow-lg max-w-xl mx-auto tracking-wide" style={{ letterSpacing: '0.01em' }}>
...
<section className="py-16 bg-white">
  <div className="container mx-auto px-4">
    {/* Heading */}
    <div className="mb-16">
      <div className="flex flex-col lg:flex-row items-center justify-center mb-10 text-center lg:text-left">
        <div className="hidden lg:block flex-1 mr-8">
          <div className="h-0.5 bg-gradient-to-l from-lightblue via-cyan-500 to-transparent"></div>
        </div>
        <div className="px-6">
    ...
    {/* Stats Grid */}
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-6 md:px-10 lg:px-0">
      {organizationStats.map((stat, index) => (
        <motion.div
          key={index}
          className="group relative overflow-hidden bg-white/30 backdrop-blur-md border border-white/40 shadow-xl rounded-2xl p-6 text-center flex flex-col items-center gap-3 max-w-sm mx-auto transition-transform duration-300"
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center">
            <div className="w-12 h-12 bg-lightblue/80 group-hover:bg-white transition-colors duration-500 backdrop-blur-sm rounded-full flex items-center justify-center mb-3 border border-white/30 group-hover:rotate-[360deg] transition-transform duration-700">
              <stat.icon className="w-7 h-7 text-white group-hover:text-lightblue transition-colors duration-500" strokeWidth={2.2} />
            </div>
            <h3 className="text-lg md:text-xl font-bold text-lightblue group-hover:text-darkblue transition-colors duration-500 mb-1">
              {stat.label}
            </h3>
            <div className="text-2xl md:text-3xl font-extrabold text-darkblue mb-2">{stat.number}</div>
            <p className="text-sm md:text-base text-gray font-light leading-relaxed">{stat.description}</p>
          </div>
        </motion.div>
      ))}
    </div>
      ...
      <section id="our-journey" className="py-20 bg-white">
        ...
        {(() => {
          ...
          return (
            <div className="relative max-w-3xl mx-auto  p-4 sm:p-9 lg:p-8">
              ...
              <div className="flex flex-col gap-6 relative z-10">
                ...
                <div className={`flex flex-col sm:flex-row items-center relative mb-4`}>
                  ...
                  <div className="w-full r sm:w-1/2 flex justify-end relative">
                    <div className={`relative mr-4 text-center bg-white/60 backdrop-blur-lg rounded-2xl p-5 shadow-2xl border-l-4 ${first.border} max-w-md w-full text-left ml-4`}>
                ...
                {showAll && middle.map((item, idx) => (
                  <div key={idx} className={`flex flex-col sm:${item.left ? 'flex-row' : 'flex-row-reverse'} items-center relative mb-4`}>
                    ...
                    <div className={`w-full sm:w-1/2 flex ${item.left ? 'justify-end' : 'justify-start'} relative`}>
                      <div className={`relative  mr-4 text-center bg-white/60 backdrop-blur-lg rounded-2xl p-5 shadow-2xl border-l-4 ${item.border} max-w-md w-full text-left ${item.left ? 'ml-4' : 'mr-4'}`}>
                ...
                <div className={`flex flex-col sm:flex-row items-center relative mb-4`}>
                  ...
                  <div className="w-full sm:w-1/2 flex justify-end relative">
                    <div className={`relative mr-4 text-center bg-white/60 backdrop-blur-lg rounded-2xl p-5 shadow-2xl border-l-4 ${last.border} max-w-md w-full text-left ml-4`}>
                      ...
                      <p className="text-gray-700  font-medium leading-relaxed">{last.desc}</p>
                    </div>
                  </div>
                </div>
              </div>
