    ...
    <section className="py-12 bg-white shadow-lg">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          >
            <div 
              className="w-12 h-12 bg-lightblue/80 backdrop-blur-sm rounded-full flex items-center justify-center mx-auto mb-4 border border-white/20 group-hover:rotate-[360deg] transition-transform duration-700"
            >
            ...
            >
              <Link
                href="/donate"
                className="inline-flex items-center bg-lightblue text-white hover:bg-lightblue/90 px-6 py-2 rounded-full font-semibold transition-all duration-300 shadow-lg hover:shadow-xl text-sm group"
              >
                Donate Now
                <motion.div
                  className="ml-2"
