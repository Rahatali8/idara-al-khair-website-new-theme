...
import { ArrowRight, BookOpen, Utensils, Stethoscope, Laptop, Shield, Heart, Users, Globe } from "lucide-react"
            ...
            <Link href={project.link} key={project.id}>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="inline-flex items-center text-teal-600 hover:text-teal-700 font-semibold transition-colors group">
                    Learn More
                    <ArrowRight
